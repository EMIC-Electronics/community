...
typedef struct i2c_config_t_
{
	...
	const uint16_t frec;// 100 = 100khz; 400 = 400khz; 1000 = 1Mhz
	const uint8_t address;// recive adress
	const uint8_t i2c_chanel;// 1 = I2C1; 2 = I2C2
	const uint8_t en_interrupt;// 0 = no interrupts; 1 = interrupt enable
