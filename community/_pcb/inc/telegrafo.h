...
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB0.h,name=key_1)		//Pulsos cortos
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB1.h,name=key_2)		//Pulsos largos
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB2.h,name=buzzer)		//Zumbador
