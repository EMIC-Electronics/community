...
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB15.h,name=Rele1)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB14.h,name=Rele2)

#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB6.h,name=Led1)

#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB8.h,name=SCL_)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB9.h,name=SDA_)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB2.h,name=SDA__)

//#define _I2C_ID 0x56
#include "myId.h"

#define nombrePCB "HRD_X2_RELAY"
