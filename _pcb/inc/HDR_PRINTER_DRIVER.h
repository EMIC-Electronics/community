...
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB14.h,name=PRINTER_TX)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB10.h,name=PRINTER_RTS)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB12.h,name=PRINTER_RX)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB15.h,name=PRINTER_CTS)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB13.h,name=PRINTER_DTR)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB11.h,name=PRINTER_CD)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB9.h,name=PRINTER_DSR)
...
#define nombrePCB "HRD_PRINTER_DRIVER"
