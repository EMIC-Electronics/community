...
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB14.h,name=MCP2200_RST)		
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB13.h,name=MCP2200_SSPND)		
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB12.h,name=MCP2200_USBCFG)		

#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB6.h,name=Led1)

#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB10.h,name=MCP2200_TX)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB15.h,name=MCP2200_RX)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB11.h,name=MCP2200_RTS)
#newRFIcode(_hal/.{UC_FAMILY}./_hard/pines/setPinB7.h,name=MCP2200_CTS)
